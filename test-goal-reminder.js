...
// Run with: node test-goal-reminder.js

const nodemailer = require('nodemailer');
require('dotenv').config({ path: '.env.local' });

async function sendGoalReminder() {
  console.log('📬 Sending goal reminder email to abdousentore@gmail.com...\n');
  ...
  // Get pending goals count (you can modify this)
  const pendingGoals = 3; // Replace with actual count from your dashboard
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Your command center has identified <strong>${pendingGoals}</strong> active mission(s) requiring your immediate attention. The fleet is counting on your execution.</p>
          ...
          <center>
            <a href="http://localhost:3000/dashboard" class="button">VIEW YOUR MISSIONS</a>
          </center>
        </div>
        <div class="footer">
          <p><strong>CLASSIFIED:</strong> Mission briefings enabled by your preferences.</p>
          <p><a href="http://localhost:3000/settings">Modify notification settings</a></p>
        </div>
      </div>
    </body>
    </html>
